      ...
      <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        <section>
          ...
          <div className="mt-5 flex items-baseline gap-3">
            <p className="text-3xl font-semibold text-navy">{formatCurrency(price)}</p>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2">
            ...
            <a
              ...
              className="focus-ring inline-flex w-full items-center justify-center gap-2 rounded-full border border-ink px-6 py-4 text-sm font-semibold"
            >
